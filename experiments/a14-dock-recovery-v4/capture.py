...
def main():
    ...
    print('A14 dock boot recovery v4 recorder — read-only', flush=True)
    ...
    with tempfile.TemporaryDirectory(prefix='a14-dsc-baseline-') as tmp:
        ...
        for name in ('a14_dp_dsc_test', 'a14_dp_dsc_144_test', 'a14_dp_dsc_wake_test', 'a14_dp_aux_wake_test', 'a14_edp_retry_test', 'a14_dp_pair_config_test', 'a14_dp_sink_power_test', 'a14_dp_state_trace_test', 'a14_dp_config_reuse_test', 'a14_dp_repeater_restore_test'):
