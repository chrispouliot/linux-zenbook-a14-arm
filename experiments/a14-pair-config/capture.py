...
def main():
    ...
    print('A14 combined receiver-configuration recorder v1 — read-only', flush=True)
    ...
    with tempfile.TemporaryDirectory(prefix='a14-dsc-baseline-') as tmp:
        ...
        for name in ('a14_dp_dsc_test', 'a14_dp_dsc_144_test', 'a14_dp_dsc_wake_test', 'a14_dp_aux_wake_test', 'a14_edp_retry_test', 'a14_dp_pair_config_test'):
