...
| Video codec image (optional) | `qcvss8480.mbn`, used by the hardware video decoder (`video.enable`, on by default); collected when present, skipped with a warning otherwise |
